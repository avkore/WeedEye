...
if (isset($_POST["query"])) {
    ...
    WHERE (o.status=2) AND (u.name like '%" . $search . "%' OR o.order_id like '%" . $search . "%' OR u.email like '%" . $search . "%')";
} else {
    $start_from = $_POST['myVariable'];
    $limit = 10;
    $query = "SELECT * FROM orders WHERE status=2 LIMIT $start_from, $limit ";
}
